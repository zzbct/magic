        ...
        <div class="list-window">
            ...
            <div class="list-context scroll">
                <div v-for="item in data" :class="item.Passed==2?'list-item-active':'list-item-reviewed'" track-by="$index"> 
                    ...
                    <span v-show="item.Passed==2" style="color:#696969" class="status icon-legend0">&nbsp未评审</span>
    ...
    module.exports = {
        ...
        methods: {
            ...
            goReview:function(id,index){
                ...
                localStorage.setItem('stage','SOI1');
                vm.$router.go({path:'./list'});
            },
            // 条件筛选
            sift:function(){
                let vm=this;
                let address='rItem/review?stage=SOI1&passed='+vm.sfitem+'&cus='+vm.titem;
